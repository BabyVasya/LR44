...
public class NewHourBehavoiurChimProm extends Behaviour {
    ...
    public NewHourBehavoiurChimProm(CfgConsumerGraphic cfg, Agent agent) {
        this.graphic = cfg;
    }
    ...
    private void newHourSend() {
        ...
        msg.addReceiver(new AID("AgentChimPromConsumer", false));
